...
urlpatterns =  [
    ...
    path('delete/<int:id>/',login_required(Delete_history.delete_history), name='delete_history'),
    path('changeStatus/', login_required(Change_status.changeStatus),name='changeStatus'),
